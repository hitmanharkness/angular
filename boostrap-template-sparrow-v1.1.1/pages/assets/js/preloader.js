...
var spDetector = function () {
  var Detector = {
    ...
    isOlderIE: spUtils.nua.match(/msie/i) && !_this.isNewerIE,
    isAncientIE: spUtils.nua.match(/msie 6/i),
    isIE: _this.isAncientIE || _this.isOlderIE || _this.isNewerIE,
    isIE11: !!window.MSInputMethodContext && !!document.documentMode,
    isEdge: !_this.isIE11 && !_this.isIE && !!window.StyleMedia,
    isChrome: !!window.chrome && !!window.chrome.webstore,
    isBlink: (_this.isChrome || _this.isOpera) && !!window.CSS,
